...
public class AlgoritmoFloyd<V, E> {

    public AlgoritmoFloyd() {

    }

    public coleccionCamino<V, E> algoritmoFloyd(Graph<V, E> g) {
        ...
        return Floyd(pesos, numAristas, g);
    }

    coleccionCamino<V, E> Floyd(Object[][] pesos, int numVertices, Graph<V, E> g) {
